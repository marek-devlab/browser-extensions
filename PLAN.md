...
|---|---|---|
| **Фреймворк** | **WXT** `0.21.4` (обновлено 2026-09-16; выбран `0.20.27` 2026-06-23) | 10.2k★, коммиты недельной давности. Единственный, кто собирает Chrome+Firefox+Safari и MV2+MV3 из одной кодовой базы |
