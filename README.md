...
| Файл | Что внутри |
|---|---|
| [`TODO.md`](./TODO.md) | **Единый бэклог.** Что осталось по существующим четырём и что делать по новым пяти. Начинать отсюда |
| [`PLAN.md`](./PLAN.md) | Research и архитектура первых четырёх (blur, adblock, perf, seo) |
| [`PLAN-2.md`](./PLAN-2.md) | Research и архитектура второй волны: capture, devdata, export, assets, whoami, compose. Не начаты |
...
| [`docs/audit/`](./docs/audit/) | Аудит существующих четырёх (2026-07-14): безопасность, отказоустойчивость, готовность к стору |
