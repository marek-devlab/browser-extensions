...
Появился как погашение долга из [`PLAN.md`](../../PLAN.md) §18 и [`PLAN-2.md`](../../PLAN-2.md) §7: первые четыре расширения дублировали два расходящихся набора токенов копипастой. Вторая волна (шесть расширений) импортирует **один** набор отсюда. Существующие четыре мигрируют на него отдельной задачей (`TODO.md` §E) — этот пакет их пока не трогает.
